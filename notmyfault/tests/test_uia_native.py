...
def test_uia_selector_requires_reusable_target_identity():
    from notmyfault.actions.uia_automation.nmf_uia_plugin.uia import DesktopElementError, validate_selector
...
def test_uia_selector_scoring_prefers_automation_id():
    from notmyfault.actions.uia_automation.nmf_uia_plugin import uia
...
def test_uia_selector_rejects_ambiguous_matches():
    from notmyfault.actions.uia_automation.nmf_uia_plugin.uia import DesktopElementError, _best
...
def test_uia_text_write_requires_writable_value_pattern():
    from notmyfault.actions.uia_automation.nmf_uia_plugin.uia import _supports_text_write
...
def test_uia_selector_rejects_password_element_before_capture():
    from notmyfault.actions.uia_automation.nmf_uia_plugin.uia import DesktopElementError, _selector_from_element
...
def test_uia_selector_uses_highest_non_desktop_parent():
    from notmyfault.actions.uia_automation.nmf_uia_plugin.uia import _tree_root_window
